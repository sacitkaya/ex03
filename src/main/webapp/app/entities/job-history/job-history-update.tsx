      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.jobHistory.home.createOrEditLabel" data-cy="JobHistoryCreateUpdateHeading">
            <Translate contentKey="ex03App.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex03App.jobHistory.startDate')}
              ...
              />
              <ValidatedField
                label={translate('ex03App.jobHistory.endDate')}
              ...
              />
              <ValidatedField
                label={translate('ex03App.jobHistory.language')}
              ...
              >
                {languageValues.map(language => (
                  <option value={language} key={language}>
                    {translate('ex03App.Language.' + language)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField id="job-history-job" name="job" data-cy="job" label={translate('ex03App.jobHistory.job')} type="select">
                <option value="" key="0" />
                {jobs
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('ex03App.jobHistory.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
              ...
              <ValidatedField
                ...
                name="employee"
                data-cy="employee"
                label={translate('ex03App.jobHistory.employee')}
                type="select"
              >
                <option value="" key="0" />
                {employees
