    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobDetailsHeading">
          <Translate contentKey="ex03App.job.detail.title">Job</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="jobTitle">
              <Translate contentKey="ex03App.job.jobTitle">Job Title</Translate>
            </span>
          </dt>
          <dd>{jobEntity.jobTitle}</dd>
          <dt>
            <span id="minSalary">
              <Translate contentKey="ex03App.job.minSalary">Min Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.minSalary}</dd>
          <dt>
            <span id="maxSalary">
              <Translate contentKey="ex03App.job.maxSalary">Max Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.maxSalary}</dd>
          <dt>
            <Translate contentKey="ex03App.job.task">Task</Translate>
          </dt>
          <dd>
            {jobEntity.tasks
          ...
          <dt>
            <Translate contentKey="ex03App.job.employee">Employee</Translate>
          </dt>
