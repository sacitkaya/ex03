      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.job.home.createOrEditLabel" data-cy="JobCreateUpdateHeading">
            <Translate contentKey="ex03App.job.home.createOrEditLabel">Create or edit a Job</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('ex03App.job.jobTitle')} id="job-jobTitle" name="jobTitle" data-cy="jobTitle" type="text" />
              <ValidatedField
                label={translate('ex03App.job.minSalary')}
                id="job-minSalary"
                name="minSalary"
                data-cy="minSalary"
                type="text"
              />
              <ValidatedField
                label={translate('ex03App.job.maxSalary')}
                id="job-maxSalary"
                name="maxSalary"
                data-cy="maxSalary"
                type="text"
              />
              <ValidatedField label={translate('ex03App.job.task')} id="job-task" data-cy="task" type="select" multiple name="tasks">
                <option value="" key="0" />
                {tasks
              ...
              <ValidatedField id="job-employee" name="employee" data-cy="employee" label={translate('ex03App.job.employee')} type="select">
                <option value="" key="0" />
                {employees
