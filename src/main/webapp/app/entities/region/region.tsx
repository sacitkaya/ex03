  ...
  return (
    <div>
      <h2 id="region-heading" data-cy="RegionHeading">
        <Translate contentKey="ex03App.region.home.title">Regions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ex03App.region.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/region/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ex03App.region.home.createLabel">Create new Region</Translate>
          </Link>
        </div>
      </h2>
        ...
        {regionList && regionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ex03App.region.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ex03App.region.regionName">Region Name</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ex03App.region.home.notFound">No Regions found</Translate>
            </div>
          )
        )}
      </div>
