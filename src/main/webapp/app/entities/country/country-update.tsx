      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="ex03App.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex03App.country.countryName')}
                id="country-countryName"
                name="countryName"
                data-cy="countryName"
                type="text"
              />
              <ValidatedField id="country-region" name="region" data-cy="region" label={translate('ex03App.country.region')} type="select">
                <option value="" key="0" />
                {regions
