  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="ex03App.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ex03App.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/country/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ex03App.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ex03App.country.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ex03App.country.countryName">Country Name</Translate>
                </th>
                <th>
                  <Translate contentKey="ex03App.country.region">Region</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ex03App.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
