      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.location.home.createOrEditLabel" data-cy="LocationCreateUpdateHeading">
            <Translate contentKey="ex03App.location.home.createOrEditLabel">Create or edit a Location</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex03App.location.streetAddress')}
              ...
              />
              <ValidatedField
                label={translate('ex03App.location.postalCode')}
                id="location-postalCode"
                name="postalCode"
                data-cy="postalCode"
                type="text"
              />
              <ValidatedField label={translate('ex03App.location.city')} id="location-city" name="city" data-cy="city" type="text" />
              <ValidatedField
                label={translate('ex03App.location.stateProvince')}
              ...
              <ValidatedField
                ...
                name="country"
                data-cy="country"
                label={translate('ex03App.location.country')}
                type="select"
              >
                <option value="" key="0" />
                {countries
