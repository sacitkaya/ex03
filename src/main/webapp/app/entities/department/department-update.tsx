      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="ex03App.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex03App.department.departmentName')}
              ...
              <ValidatedField
                ...
                name="location"
                data-cy="location"
                label={translate('ex03App.department.location')}
                type="select"
              >
                <option value="" key="0" />
                {locations
