  ...
  return (
    <div>
      <h2 id="department-heading" data-cy="DepartmentHeading">
        <Translate contentKey="ex03App.department.home.title">Departments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ex03App.department.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/department/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ex03App.department.home.createLabel">Create new Department</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departmentList && departmentList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ex03App.department.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ex03App.department.departmentName">Department Name</Translate>
                </th>
                <th>
                  <Translate contentKey="ex03App.department.location">Location</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ex03App.department.home.notFound">No Departments found</Translate>
            </div>
          )
        )}
      </div>
