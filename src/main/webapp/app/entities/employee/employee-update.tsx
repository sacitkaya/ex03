      ...
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ex03App.employee.home.createOrEditLabel" data-cy="EmployeeCreateUpdateHeading">
            <Translate contentKey="ex03App.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ex03App.employee.firstName')}
              ...
              <ValidatedField
                label={translate('ex03App.employee.lastName')}
                id="employee-lastName"
                name="lastName"
                data-cy="lastName"
                type="text"
              />
              <ValidatedField label={translate('ex03App.employee.email')} id="employee-email" name="email" data-cy="email" type="text" />
              <ValidatedField
                label={translate('ex03App.employee.phoneNumber')}
              ...
              />
              <ValidatedField
                label={translate('ex03App.employee.hireDate')}
              ...
              />
              <ValidatedField
                label={translate('ex03App.employee.salary')}
                id="employee-salary"
                name="salary"
                data-cy="salary"
                type="text"
              />
              <ValidatedField
                label={translate('ex03App.employee.commissionPct')}
              ...
              <ValidatedField
                ...
                name="manager"
                data-cy="manager"
                label={translate('ex03App.employee.manager')}
                type="select"
              >
                <option value="" key="0" />
                {employees
              ...
              <ValidatedField
                ...
                name="department"
                data-cy="department"
                label={translate('ex03App.employee.department')}
                type="select"
              >
                <option value="" key="0" />
                {departments
